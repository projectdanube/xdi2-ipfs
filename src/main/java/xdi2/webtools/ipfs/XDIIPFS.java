...
public class XDIIPFS extends HttpServlet implements HttpRequestHandler {

	private static final long serialVersionUID = 6222742990137314344L;

	private static final Logger log = LoggerFactory.getLogger(XDIIPFS.class);
	...
	static {
		...
		while (true) {
			...
			InputStream inputStream = XDIIPFS.class.getResourceAsStream("message" + (sampleInputs.size() + 1) + ".xdi");
